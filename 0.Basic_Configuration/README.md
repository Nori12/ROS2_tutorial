...
Since ROS2 is by nature distributed, if you are connected to the same network that is executing topics/nodes, you are susceptible to see them from your computer. To avoid this, modify the `.bashrc` file:
```bash
cd ~
vim .bashrc
```
